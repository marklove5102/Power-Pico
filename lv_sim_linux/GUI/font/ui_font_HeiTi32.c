...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 10, .adv_w = 284, .box_w = 16, .box_h = 23, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 194, .adv_w = 284, .box_w = 9, .box_h = 23, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 298, .adv_w = 284, .box_w = 17, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 485, .adv_w = 284, .box_w = 16, .box_h = 23, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 669, .adv_w = 284, .box_w = 17, .box_h = 23, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 865, .adv_w = 284, .box_w = 16, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1041, .adv_w = 284, .box_w = 16, .box_h = 23, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1225, .adv_w = 284, .box_w = 16, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1401, .adv_w = 284, .box_w = 16, .box_h = 23, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1585, .adv_w = 284, .box_w = 16, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1761, .adv_w = 142, .box_w = 5, .box_h = 17, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1804, .adv_w = 340, .box_w = 21, .box_h = 23, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2046, .adv_w = 340, .box_w = 21, .box_h = 23, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2288, .adv_w = 482, .box_w = 30, .box_h = 23, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2633, .adv_w = 424, .box_w = 23, .box_h = 18, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2840, .adv_w = 284, .box_w = 14, .box_h = 17, .ofs_x = 2, .ofs_y = 0}
};
